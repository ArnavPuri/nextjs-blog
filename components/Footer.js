export default function Footer(props) {
    return (
        <div className="footer-container" style={{}}>
            <div className="links">
                <a className="social-link" href="https://github.com/arnavpuri" target="_blank">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={"#FFFFFB"}
                         width={"32px"}>
                        <path
                ...
                <a className="social-link" href="https://twitter.com/arnavpuri" target="_blank">
                    <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill={"#FFFFFB"}
                         width={"32px"}>
                        <path
                ...
                <a className="social-link" href="mailto:reach@arnavpuri.com" target="_blank">
                    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 512 512"
                         fill={"#FFFFFB"} width={"32px"}>
                        <g>
